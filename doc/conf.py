# -*- coding: utf-8 -*-
#
# pySC documentation build configuration file, originally created for omc3 by
...
project = ABOUT_PYSC["__title__"]
copyright_ = '2023, Lukas Malina'
author = ABOUT_PYSC["__author__"]

rst_prolog = f"""
:github_url: {ABOUT_PYSC['__url__']}
"""
...
version = ABOUT_PYSC["__version__"][:3]
# The full version, including alpha/beta/rc tags.
release = ABOUT_PYSC["__version__"]
...
html_logo = '_static/img/pySC_logo.png'
...
latex_documents = [
    (master_doc, 'pysc.tex', u'pySC Documentation',
     u'Lukas Malina', 'manual'),
]
...
man_pages = [
    (master_doc, 'pysc', u'pySC Documentation',
     [author], 1)
]
